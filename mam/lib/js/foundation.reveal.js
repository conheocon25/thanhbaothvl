;(function ($, window, document, undefined) {
  ...
  Foundation.libs.reveal = {
    ...
    settings : {
      ...
      save_dismiss_modal_class: 'save-and-close-modal',
    ...
    events : function (scope) {
      ...
      S(document)
        ...
        S(document)
        .on('touchend.fndtn.reveal click.fndtn.reveal', this.save_close_targets(), function (e) {
    ...
    save_close_targets : function () {
      var base1 = '.' + this.settings.save_dismiss_modal_class;

      if (this.settings.close_on_background_click) {
        return base1 + ', .' + this.settings.bg_class;
      }
