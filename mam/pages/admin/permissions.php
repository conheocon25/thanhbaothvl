...
# ------------ Thêm quyền Không cho phép chỉnh sửa Resource Types
	DrawOption("Tx", "Không cho phép thay đổi Kiểu tư liệu", true);
...
# ------------ Edit access to workflow states - Bỏ các quyền "Hàng đợi gửi đi", "Hàng đợi duyệt", "Hàng đợi chờ lưu", "Hàng đợi đã lưu", giữ lại quyền Trạng thái hoạt động 0 và Trạng thái đã xóa 3
#for ($n=-2;$n<=3;$n++)
#	{
#	DrawOption("e" . $n, $lang["edit_access_to_workflow_state"] . " '" . $lang["status" . $n] . "'", false);
#	}
DrawOption("e0", $lang["edit_access_to_workflow_state"] . " '" . $lang["status" . "0"] . "'", false);
DrawOption("e3", $lang["edit_access_to_workflow_state"] . " '" . $lang["status" . "3"] . "'", false);
...
DrawOption("Cf", "Cho phép tạo thư mục", false);
DrawOption("Df", "Cho phép xóa thư mục", false);
...
DrawOption('dl', "Không cho phép tải tư liệu gốc", true);
...
DrawOption("apr", "Có thể Duyệt / Không duyệt Clip");
