<?php 
function tpl_50fa0f14_UpdatePriceResourceI__Cal5jlRyvc93S__7BrWfow(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRI, 'getId')))):  ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRI, 'getNameResource')))):  ;
$_tmp_1 = ' value="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<LABEL>Giá nhập: </LABEL></td> 
								<?php /* tag "td" from line 51 */; ?>
<td align="left"><?php 
/* tag "INPUT" from line 51 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRI, 'getPrice')))):  ;
$_tmp_1 = ' value="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
Generated by PHPTAL from /home/a23app/public_html/banhreht/mvc/templates/UpdatePriceResourceImport.html (edit that file instead) */; ?>