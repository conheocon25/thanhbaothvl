<?php 
function tpl_50a5b6ce_SettingSupplierResou__7NdJO7vwavl6TT8KnAn9RA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
?>
<form id="FormSettingSupplierResourceUpdLoad" method="post" data-ajax="false" data-mini="true" class="ui-body ui-body-b ui-corner-all"<?php echo $_tmp_1 ?>
>
...
<li data-theme="a"><?php 
/* tag "a" from line 67 */ ;
if (null !== ($_tmp_4 = ($ctx->path($ctx->User, 'getApp/getURLSettingSupplier')))):  ;
...
<li><?php 
/* tag "a" from line 70 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->User, 'getApp/getURLSettingUnit')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
Generated by PHPTAL from /home/a23app/public_html/anhnguyetfarm/mvc/templates/SettingSupplierResourceUpdLoad.html (edit that file instead) */; ?>