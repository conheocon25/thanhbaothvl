<?php 
function tpl_50ad09d3_SettingPondSessionDe__UpXGMBbLeEl3rxMjTxxGdA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<p>Bạn thật sự muốn xóa vụ nuôi này !?</p>
				<?php 
/* tag "form" from line 19 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->PondSession, 'getURLDelExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form data-ajax="false" method="post" class="ui-body ui-body-b ui-corner-all"<?php echo $_tmp_1 ?>
>
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 37 */; ?>
...
Generated by PHPTAL from /home/a23app/public_html/anhnguyetfarm/mvc/templates/SettingPondSessionDelLoad.html (edit that file instead) */; ?>