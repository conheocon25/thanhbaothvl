...
class CategoryPaid extends Mapper implements \MVC\Domain\CategoryPaidFinder {
    function __construct() {
		...
		$tblCategory = "chuakhaituong_category_paid";
    ...
    function getCollection( array $raw ) {return new CategoryPaidCollection( $raw, $this );}
    ...
    protected function targetClass() { return "CategoryPaid";}
	...
	function findByPage( $values ) {		
        ...
        return new CategoryPaidCollection( $this->findByPageStmt->fetchAll(), $this );
    }
}
?>