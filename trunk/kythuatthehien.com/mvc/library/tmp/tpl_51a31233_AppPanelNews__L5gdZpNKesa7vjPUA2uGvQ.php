<?php 
function tpl_51a31233_AppPanelNews__L5gdZpNKesa7vjPUA2uGvQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "tr" from line 22 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Panel = new PHPTAL_RepeatController($ctx->PanelNews)
 ;
$ctx = $tpl->pushContext() ;
...
<a href="app/panel/news/ins/load">
...
Generated by PHPTAL from E:\AppWebServer\chuakhaituong.123app.net\mvc\templates\AppPanelNews.html (edit that file instead) */; ?>