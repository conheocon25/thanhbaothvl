<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_NorthBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_SouthBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div class="sidebar-box">
		<?php /* tag "div" from line 644 */; ?>
<div class="box-title">
			<?php /* tag "img" from line 645 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 646 */; ?>
<span>Phật Giáo Nam Tông</span>
		</div>
		<?php /* tag "div" from line 648 */; ?>
<div style="text-align:center; padding:5px 5px 1px 5px;">
			<?php /* tag "a" from line 649 */; ?>
<a href="/library/video/2">
				<?php /* tag "img" from line 650 */; ?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_TopPictureBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div class="sidebar-box">
		<?php /* tag "div" from line 628 */; ?>
<div class="box-title">
			<?php /* tag "img" from line 629 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 630 */; ?>
<span>Ảnh Hoạt Động</span>
		</div>
		<?php /* tag "div" from line 632 */; ?>
<div style="text-align:center; padding:5px 5px 1px 5px;">
			<?php /* tag "a" from line 633 */; ?>
<a href="/library/album">
				<?php /* tag "img" from line 634 */; ?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_BoxAds(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="box-title">
			<?php /* tag "img" from line 612 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 613 */; ?>
<span>Quảng cáo</span>
		</div>
		<?php 
/* tag "div" from line 615 */ ;
$_tmp_4 = $ctx->repeat ;
$_tmp_4->Ads = new PHPTAL_RepeatController($ctx->PanelAdsAll)
 ;
$ctx = $tpl->pushContext() ;
...
/* tag "a" from line 616 */ ;
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_2 = ($ctx->path($ctx->Ads, 'getNews/getURLRead', true)))):  ;
...
$ctx->noThrow(false) ;
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_3 = ($ctx->path($ctx->Ads, 'getNews/getTitle', true)))):  ;
...
>
				<?php 
/* tag "img" from line 617 */ ;
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_1 = ($ctx->path($ctx->Ads, 'getNews/getImage', true)))):  ;
...
/>
				<?php /* tag "div" from line 618 */; ?>
<div class="box-right-title"><?php 
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_1 = $ctx->path($ctx->Ads, 'getNews/getTitle', true))):  ;
?>
<?php 
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_BoxRightCategorys(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="box-title">
			<?php /* tag "img" from line 592 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 593 */; ?>
<span>Những Chuyen Muc Video</span>
		</div>
		<?php /* tag "div" from line 595 */; ?>
<div class="BoxListNews">
			<?php /* tag "ul" from line 596 */; ?>
<ul>
				<?php 
/* tag "li" from line 597 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Category = new PHPTAL_RepeatController($ctx->CategorysArray)
 ;
$ctx = $tpl->pushContext() ;
...
?>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_TopVideoBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div class="sidebar-box">
		<?php /* tag "div" from line 577 */; ?>
<div class="box-title">
			<?php /* tag "img" from line 578 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 579 */; ?>
<span>Những Video Nổi Bật</span>
		</div>
		<?php 
/* tag "div" from line 581 */ ;
$_tmp_4 = $ctx->repeat ;
...
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_1 = ($ctx->path($ctx->Category, 'getCategoryVideo/getPicture', true)))):  ;
$_tmp_1 = ' src="'.phptal_escape($_tmp_1).'"' ;
elseif (null !== ($_tmp_1 = ('/data/images/exit_picture.jpg'))):  ;
$_tmp_1 = ' src="'.phptal_escape($_tmp_1).'"' ;
endif ;
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_BoxRight(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="box-title">
			<?php /* tag "img" from line 561 */; ?>
<img src="/data/images/icon.png" width="30"/>
			<?php /* tag "span" from line 562 */; ?>
<span>Những Tin Tức Mới Cập Nhật</span>
		</div>
		<?php 
/* tag "div" from line 564 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->TopNews = new PHPTAL_RepeatController($ctx->PanelNews)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->TopNews as $ctx->TopNews): ;
?>
<div class="box-right">
			<?php 
/* tag "a" from line 565 */ ;
...
$ctx->noThrow(false) ;
$ctx->noThrow(true) ;
if (!phptal_isempty($_tmp_3 = ($ctx->path($ctx->TopNews, 'getNews/getTitle', true)))):  ;
$_tmp_3 = ' title="'.phptal_escape($_tmp_3).'"' ;
elseif (null !== ($_tmp_3 = ('Chưa có tiêu đề'))):  ;
$_tmp_3 = ' title="'.phptal_escape($_tmp_3).'"' ;
endif ;
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_AdminMenu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
if (null !== ($_tmp_2 = ($ctx->ActiveAdmin=='PanelAds'?'menu-select':'?'))):  ;
$_tmp_2 = ' class="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<div class="left">QUẢNG CÁO</div>
					<?php /* tag "div" from line 544 */; ?>
<div class="right"><?php echo phptal_escape($ctx->path($ctx->PanelAdsAll, 'count')); ?>
</div>
				</li>
			</a>
			<?php 
...
<div class="right"><?php echo phptal_escape($ctx->path($ctx->Configs, 'count')); ?>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="http://chuaquocankhaituong.vn">http://chuaquocankhaituong.vn</a>)</small>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_CountBoxMini(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_CountBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_SponsorBoxMini(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_SponsorBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_TextGo(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<marquee>Kính chúc chư tôn đức tăng ni cùng quý phật tử thân tâm thường an lạc ! Nguyện đem công đức này hướng về khắp tất cả đệ tử và chúng sanh điều trọn thành Phật Đạo.</marquee>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_DateTimeBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript">				
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_CallendarBoxMini(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_CallendarBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_AskBoxMini(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_AskBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_VideoBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_CourseBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
if ($ctx->Course):  ;
...
?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_EventBoxMini(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_EventBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="clear"></div>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/contact">Liên hệ</a>
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/SigninLoad.js"></script>		
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/base/jquery.countdown.css"/> 
 ...
 ?>
<?php 
function tpl_51a56064_macros__x6FYd5UW5CqAyLKo2_POnA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
<body>
	...
	<!-- TOP PICTURE BOX 																		-->
	<!-- ================================================================================== -->
	<?php /* tag "div" from line 627 */; ?>

	
	<!-- ================================================================================== -->
	<!-- SOUTH BUDDHA																	-->
	<!-- ================================================================================== -->
	<?php /* tag "div" from line 643 */; ?>

	
	<!-- ================================================================================== -->
	<!-- NORTH BUDDHA																	-->
	<!-- ================================================================================== -->
	<?php /* tag "div" from line 659 */; ?>
