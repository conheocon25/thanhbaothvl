<?php 
function tpl_51623f03_LibraryVideo__onmdGVgj8HSVBMvtWSAQrg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->VM2s, 'current/getVideo/getURL')))):  ;
...
<div class="name"><?php echo phptal_escape($ctx->path($ctx->VM2s, 'current/getVideo/getName')); ?>
</div>
							<?php /* tag "div" from line 59 */; ?>
<div class="monk">Giảng sư: 
								<?php 
/* tag "a" from line 60 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->VM2s, 'current/getMonk/getURLRead')))):  ;
...
<span><?php echo phptal_escape($ctx->path($ctx->VM2s, 'current/getMonk/getPreName')); ?>
</span> - 
									<?php /* tag "span" from line 62 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->VM2s, 'current/getMonk/getName')); ?>
</span>
								</a>
							</div>						
...
<span><?php echo phptal_escape($ctx->path($ctx->VM2s, 'current/getVideo/getCountPrint')); ?>
</span> lượt xem
							</div>
...
/* tag "li" from line 80 */ ;
$_tmp_2 = $ctx->repeat ;
$_tmp_2->VM = new PHPTAL_RepeatController($ctx->VM1s)
 ;
$ctx = $tpl->pushContext() ;
...
$_tmp_4 = $ctx->repeat ;
$_tmp_4->VM = new PHPTAL_RepeatController($ctx->VM2s)
 ;
$ctx = $tpl->pushContext() ;
...
/* tag "a" from line 121 */ ;
$_tmp_2 = $ctx->repeat ;
$_tmp_2->Monk = new PHPTAL_RepeatController($ctx->Monks)
 ;
$ctx = $tpl->pushContext() ;
...
$ctx->pushSlots() ;
$tpl->_executeMacroOfTemplate('macros.xhtml/EventBoxMini', $_thistpl) ;
$ctx->popSlots() ;
?>
