<?php 
function tpl_51a31233_LibraryVideoCategory__z6NZc4TLqO1L2ApyX2ZcRg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
/* tag "a" from line 23 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->Category1 = new PHPTAL_RepeatController($ctx->path($ctx->CategoryBType, 'getCategoryAll'))
 ;
$ctx = $tpl->pushContext() ;
...
/* tag "a" from line 69 */ ;
$_tmp_3 = $ctx->repeat ;
$_tmp_3->Monk = new PHPTAL_RepeatController($ctx->path($ctx->CategoryBType, 'getMonkAll'))
 ;
$ctx = $tpl->pushContext() ;
