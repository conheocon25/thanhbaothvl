<?php 
function tpl_51975f97_Home__O1PbjDaBjrOrcDSf6MUhPg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
$ctx->pushSlots() ;
$tpl->_executeMacroOfTemplate('macros.xhtml/BoxRightCategorys', $_thistpl) ;
$ctx->popSlots() ;
?>

					<!--<div metal:use-macro="macros.xhtml/TopVideoBox"/> -->
					<?php 
