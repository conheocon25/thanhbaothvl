<?php 
function tpl_51a31233_AppCategoryVideoDeta__8AtZUNM3JxuDjfhpBaGSVA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td><?php echo phptal_escape($ctx->path($ctx->VL, 'getVideo/getTimePrint')); ?>
</td>
...
<div class="left"><?php echo phptal_escape($ctx->path($ctx->Category1, 'getNameReduce')); ?>
</div>
										<?php /* tag "div" from line 67 */; ?>
<div class="right"><?php echo phptal_escape($ctx->path($ctx->Category1, 'getVLs/count')); ?>
</div>
									</li>
								</a><?php 
endforeach ;
