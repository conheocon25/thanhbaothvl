<?php 
function tpl_51a31232_ReadCategory__dZeAo0fzpTGhWQyTDEZ2RA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span><?php echo phptal_escape($ctx->path($ctx->News, 'getTitleReduce')); ?>
</span>
						</div>
...
/* tag "li" from line 30 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->News = new PHPTAL_RepeatController($ctx->path($ctx->Category, 'getNewsLimit'))
 ;
$ctx = $tpl->pushContext() ;
