<?php 
function tpl_51623f03_AppConfigUpdLoad__PvNbZmC1_TRz31jzVxdMaw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Config, 'getURLUpdExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form class="form-editor" id="FormAppConfigUpdLoad" method="post"<?php echo $_tmp_1 ?>
>
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Config, 'getParam')))):  ;
$_tmp_2 = ' value="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
?>
<input id="Param" name="Param" type="text"<?php echo $_tmp_2 ?>
/>
								</div>
...
Generated by PHPTAL from E:\AppWebServer\chuakhaituong.123app.net\mvc\templates\AppConfigUpdLoad.html (edit that file instead) */; ?>