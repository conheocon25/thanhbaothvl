<?php 
function tpl_51623f04_LibraryVideoMonkPlay__F_UUK665qLVkVrjdR0NqXw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
?>
<iframe width="450" height="350" frameborder="0"<?php echo $_tmp_2 ?>
></iframe>
...
<span><?php echo phptal_escape($ctx->path($ctx->VM, 'getMonk/getName')); ?>
</span>
							</div>						
...
<div class="news-box-sub-title">Cùng giảng sư</div>
...
/* tag "li" from line 68 */ ;
$_tmp_1 = $ctx->repeat ;
$_tmp_1->VM = new PHPTAL_RepeatController($ctx->path($ctx->MonkSelected, 'getVMs'))
 ;
$ctx = $tpl->pushContext() ;
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Monk1, 'getURLRead')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
Generated by PHPTAL from E:\AppWebServer\chuakhaituong.123app.net\mvc\templates\LibraryVideoMonkPlay.html (edit that file instead) */; ?>