<?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<div id="footer">
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_page(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_main3_of3(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_main3_of1(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_MenuXemThem(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div style="border-top: 1px solid #63AFE0; padding: 0 5px 0 5px;">
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_MenuSearch(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div id="MenuSearch">
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_MenuIndex(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div id="menu">				
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_Navigation(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div id="Navigation">
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div id="header">
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA_Include(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<span>
 ...
 ?><?php 
function tpl_52627857_macros__u3fUnLg1Gpg0jH6asZGLJA($tpl, $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
?>
