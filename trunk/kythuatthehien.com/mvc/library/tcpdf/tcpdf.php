...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
		...
		$this->CoreFonts = array(
			...
			'freeserif'=>'freeserif',
			'freeserifB'=>'freeserif-Bold',
			'freeserifI'=>'freeserif-Oblique',
			'freeserifBI'=>'freeserif-BoldOblique',
			'times'=>'Times-Roman',
			'timesB'=>'Times-Bold',
			'timesI'=>'Times-Italic',
	 ...
	 * @param $family (string) Family font. It can be either a name defined by AddFont() or one of the standard Type1 families (case insensitive):<ul><li>times (Times-Roman)</li><li>timesb (Times-Bold)</li><li>timesi (Times-Italic)</li><li>timesbi (Times-BoldItalic)</li><li>freeserif (freeserif)</li><li>freeserifb (freeserif-Bold)</li><li>freeserifi (freeserif-Oblique)</li><li>freeserifbi (freeserif-BoldOblique)</li><li>courier (Courier)</li><li>courierb (Courier-Bold)</li><li>courieri (Courier-Oblique)</li><li>courierbi (Courier-BoldOblique)</li><li>symbol (Symbol)</li><li>zapfdingbats (ZapfDingbats)</li></ul> It is also possible to pass an empty string. In that case, the current family is retained.
	...
	protected function _putcatalog() {
		...
		if (!empty($this->form_obj_id) OR ($this->sign AND isset($this->signature_data['cert_type']))) {
			...
			$font = $this->getFontBuffer('freeserif');
