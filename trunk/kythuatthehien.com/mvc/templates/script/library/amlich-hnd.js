...
var TAB_WIDTHS = new Array("308px", "235px", "600px");
...
function printHead(mm, yy) {
	...
	res += ('<tr><td style="cursor:pointer;" colspan="2" style="height:25px;" class="navi-l">'+getPrevYearLink(mm, yy)+' &nbsp;'+getPrevMonthLink(mm, yy)+'</td>\n');
	//res += ('<td colspan="1" class="navig"><a href="'+getPrevMonthLink(mm, yy)+'"><img src="left1.gif" alt="Prev"></a></td>\n');
	res += ('<td style="cursor:pointer;" colspan="3" class="tenthang" onClick="showMonthSelect();">'+monthName+'</td>\n');
...
function printFoot() {
	var res = "";
	res += '<script language="JavaScript" src="/mvc/templates/script/library/amlich-hnd.js"></script>\n';
	return res;
}
