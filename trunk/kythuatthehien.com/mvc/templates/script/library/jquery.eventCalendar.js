...
;$.fn.eventCalendar = function(options){
	...
	this.each(function(){
		...
		flags.wrap = $(this);
		flags.wrap.addClass('eventCalendar-wrap').append("<div class='eventsCalendar-list-wrap'><p class='eventsCalendar-subtitle'></p><span class='eventsCalendar-loading'>Tải lên...</span><div class='eventsCalendar-list-content'><ul class='eventsCalendar-list'></ul></div></div>");
	...
	function getEventsData(data, limit, year, month, day, direction){
		...
		if (!direction) {
			...
			if (day != '') {
				subtitle.html(eventsOpts.txt_SpecificEvents_after + " " + day + " " + eventsOpts.txt_SpecificEvents_prev + eventsOpts.monthNames[month]);
				//subtitle.html("Hiểu quái gì");
			} else {
