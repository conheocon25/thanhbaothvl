<?php 
function tpl_5129fe9f_SellingCustomerUpdLo__FzG2LR_0zkL96bNlQ9gFuA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/SellingCustomerUpdLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PageSellingCustomerUpdLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->OrderExport, 'getURLUpdExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormSellingCustomerUpdLoad" data-ajax="false" method="post" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
if ($ctx->Store->getId()==$ctx->OrderExport->getIdStore()):  ;
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->OrderExport, 'getDate')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<input class="required" type="date" name="Date" id="Date"<?php echo $_tmp_3 ?>
/>
					</div>
...
<textarea cols="40" rows="8" name="Note" id="Note" data-mini="true"><?php echo phptal_escape($ctx->path($ctx->OrderExport, 'getNote')); ?>
</textarea>
					</div>				
				</fieldset>
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/SellingCustomerUpdLoad.html (edit that file instead) */; ?>