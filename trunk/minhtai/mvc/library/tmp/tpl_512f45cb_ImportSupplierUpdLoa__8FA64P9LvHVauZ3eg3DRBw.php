<?php 
function tpl_512f45cb_ImportSupplierUpdLoa__8FA64P9LvHVauZ3eg3DRBw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/ImportSupplierUpdLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PageImportSupplierUpdLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->OrderImport, 'getURLUpdExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormImportSupplierUpdLoad" data-ajax="false" method="post" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
if ($ctx->Store->getId()==$ctx->OrderImport->getIdStore()):  ;
...
if (null !== ($_tmp_3 = ($ctx->path($ctx->OrderImport, 'getDate')))):  ;
$_tmp_3 = ' value="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
<textarea cols="40" rows="8" name="Note" id="Note" data-mini="true"><?php echo phptal_escape($ctx->path($ctx->OrderImport, 'getNote')); ?>
</textarea>
					</div>				
				</fieldset>
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/ImportSupplierUpdLoad.html (edit that file instead) */; ?>