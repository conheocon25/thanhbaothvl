<?php 
function tpl_50faa873_SettingTermUpdLoad__557FbqEjXESbgYjeA4po6A(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/SettingTermUpdLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PageSettingTermUpdLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Term, 'getURLUpdExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormSettingTermUpdLoad" method="post" data-ajax="false" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
<label for="Name" class="text">Tên mục:</label>
						<?php 
/* tag "input" from line 19 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Term, 'getName')))):  ;
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/SettingTermUpdLoad.html (edit that file instead) */; ?>