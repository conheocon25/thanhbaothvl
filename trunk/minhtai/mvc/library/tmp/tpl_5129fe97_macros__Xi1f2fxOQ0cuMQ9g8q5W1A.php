<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A_MobileMenuReport(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
>CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A_MobileMenuMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
>THIẾT LẬP</a></li>
 ...
 ?>
<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A_MobileMenuSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="#Term" data-transition="none" data-inline="true">CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A_IncludeJS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/library/mobiscroll-2.0.2.custom.min.js"></script>
 ...
 ?>
<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A_IncludeCSS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<BASE href="http://minhtai.123app.net"/>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/base/mobiscroll-2.0.2.custom.min.css"/>
 ...
 ?>
<?php 
function tpl_5129fe97_macros__Xi1f2fxOQ0cuMQ9g8q5W1A(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/macros.xhtml (edit that file instead) */; ?>