...
if($gcp->loginToGoogle("gmail@gmail.com", "123456")) {
	...
	$resarray = $gcp->sendPrintToPrinter($printerid, "Printing Doc using Google Cloud Printing", "D://In.pdf", "application/pdf");
