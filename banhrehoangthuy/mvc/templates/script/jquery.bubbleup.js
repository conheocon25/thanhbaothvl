	...
	$.fn.bubbleup = function(options) {
		...
		return this.each(function() {
			...
			$(this).mouseover(function(){
				...
				$(this).closest('img').css({'z-index':100000});
				...
				$(this).closest('img').css({'z-index':100});
				$(this).closest('img').next().css({'z-index':0});
				$(this).closest('img').next().css({'z-index':0});
				$(this).closest('img').next().children('img').css({'z-index':0});
