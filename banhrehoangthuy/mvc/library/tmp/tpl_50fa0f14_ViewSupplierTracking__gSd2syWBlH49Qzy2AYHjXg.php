<?php 
function tpl_50fa0f14_ViewSupplierTracking__gSd2syWBlH49Qzy2AYHjXg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript">
		...
		$(document).ready(function(){				
				...
				$("#PrintLinked").attr("href", "?cmd=PrintSupplierTracking&DateStart="+DateStart+"&DateEnd="+DateEnd);								
...
?>
<a id="PrintLinked" target="blank" style="float:center;" class="Button StateDefault ButtonIconLeft CornerAll"<?php echo $_tmp_1 ?>
>
...
Generated by PHPTAL from /home/a23app/public_html/banhreht/mvc/templates/ViewSupplierTracking.html (edit that file instead) */; ?>