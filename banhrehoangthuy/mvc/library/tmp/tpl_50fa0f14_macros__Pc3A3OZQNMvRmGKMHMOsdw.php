<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_DialogConfirm(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<span><?php echo phptal_escape($ctx->Message); ?>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_user(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape($ctx->path($ctx->User, 'getUser')); ?>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<small>Bản quyền ©2009-2011 SPN Co, Ltd. Giữ toàn quyền.</small>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_HeaderModuleSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_HeaderModuleSuppliers(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_HeaderModuleCustomers(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_HeaderModuleFactories(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItemChecked CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_HeaderModuleMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_IncludeBase(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
if (($_tmp_1 = !($ctx->true))):  ;
...
?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_UserInfo(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_DialogSignin(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<INPUT id="UserKeyDown" size="20" type="password" name="Pass"/>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_Logo(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw_Info(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<small>(0733) 746 026</small>
 ...
 ?>
<?php 
function tpl_50fa0f14_macros__Pc3A3OZQNMvRmGKMHMOsdw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from /home/a23app/public_html/banhreht/mvc/templates/macros.xhtml (edit that file instead) */; ?>