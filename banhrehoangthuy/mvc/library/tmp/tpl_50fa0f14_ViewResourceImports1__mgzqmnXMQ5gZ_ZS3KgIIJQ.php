<?php 
function tpl_50fa0f14_ViewResourceImports1__mgzqmnXMQ5gZ_ZS3KgIIJQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td align="center"><?php /* tag "b" from line 71 */; ?>
<b><?php echo phptal_escape($ctx->path($ctx->RIT, 'getDatePrint')); ?>
</b></td>
								<?php /* tag "td" from line 72 */; ?>
<td align="center"><?php echo phptal_escape($ctx->path($ctx->RIT, 'getResource01')); ?>
</td>
							</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
Generated by PHPTAL from /home/a23app/public_html/banhreht/mvc/templates/ViewResourceImports1.html (edit that file instead) */; ?>