<?php 
function tpl_51e520b7_ViewResourceImports5__UNUvDas_mudkFOAyzyAwig(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<td align="center"><?php echo phptal_escape($ctx->path($ctx->RIT, 'getResource06')); ?>
</td>								
							</tr><?php 
endforeach ;
$ctx = $tpl->popContext() ;
...
Generated by PHPTAL from /home/banhreht/public_html/mvc/templates/ViewResourceImports5.html (edit that file instead) */; ?>