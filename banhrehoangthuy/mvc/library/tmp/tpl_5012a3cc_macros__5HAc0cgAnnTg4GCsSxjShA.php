<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_DialogConfirm(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<span><?php echo phptal_escape($ctx->Message); ?>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_user(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape($ctx->path($ctx->User, 'getUser')); ?>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<small>Bản quyền ©2009-2011 SPN Co, Ltd. Giữ toàn quyền.</small>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_HeaderModuleSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_HeaderModuleSuppliers(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_HeaderModuleCustomers(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_HeaderModuleFactories(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItemChecked CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_HeaderModuleMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="MenuItem CornerLeft" href="?cmd=ViewFactories">LÒ SẢN XUẤT</a>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_IncludeBase(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
if (($_tmp_1 = !($ctx->true))):  ;
...
?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_UserInfo(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_DialogSignin(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<INPUT id="UserKeyDown" size="20" type="password" name="Pass"/>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_Logo(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA_Info(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<small>(0733) 746 026</small>
 ...
 ?>
<?php 
function tpl_5012a3cc_macros__5HAc0cgAnnTg4GCsSxjShA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from /home/a23app/public_html/bra/mvc/templates/macros.xhtml (edit that file instead) */; ?>