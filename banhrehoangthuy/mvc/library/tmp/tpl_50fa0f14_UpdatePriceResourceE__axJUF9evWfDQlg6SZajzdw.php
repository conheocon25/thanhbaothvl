<?php 
function tpl_50fa0f14_UpdatePriceResourceE__axJUF9evWfDQlg6SZajzdw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRE, 'getId')))):  ;
...
<LABEL>Nguyên liệu: </LABEL></td> 
								<?php /* tag "td" from line 45 */; ?>
<td align="left">									
									<?php 
/* tag "INPUT" from line 46 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRE, 'getNameResource')))):  ;
$_tmp_1 = ' value="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<LABEL>Giá giao: </LABEL></td> 
								<?php /* tag "td" from line 51 */; ?>
<td align="left"><?php 
/* tag "INPUT" from line 51 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->PRE, 'getPrice')))):  ;
$_tmp_1 = ' value="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
Generated by PHPTAL from /home/a23app/public_html/banhreht/mvc/templates/UpdatePriceResourceExport.html (edit that file instead) */; ?>