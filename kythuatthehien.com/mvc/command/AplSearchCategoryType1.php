<?php
	...
	class AplSearchCategoryType1 extends Command {
		function doExecute( \MVC\Controller\Request $request ) {
			...
			//-------------------------------------------------------------			
				...
				if($IdCategory == 25000) {										
					$SalarydailyAll = $mSalarydaily->findByCateroryAllDateGroupBy(array($Y1."-".$M1."-".$D1, $Y2."-".$M2."-".$D2));																		
				} else {
					$SalarydailyAll = $mSalarydaily->findByCateroryDateGroupBy(array($IdCategory, $Y1."-".$M1."-".$D1, $Y2."-".$M2."-".$D2));						
				}
