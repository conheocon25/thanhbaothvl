<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_Backontop(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<div class="crunchify-top" data-toggle="tooltip" data-placement="left" data-original-title="Trở về đầu trang"></div><?php 
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="top-menu">
			<?php /* tag "ul" from line 333 */; ?>
<ul class="nav nav-pills">
				<?php 
/* tag "li" from line 334 */ ;
if (null !== ($_tmp_4 = ($ctx->ActiveItem=='Home'?'active':'?'))):  ;
...
<a href="/trang-chu">Trang chủ</a></li>
				<?php 
/* tag "li" from line 335 */ ;
if (null !== ($_tmp_3 = ($ctx->ActiveItem=='Introduction'?'active':'?'))):  ;
...
?>
<li<?php echo $_tmp_3 ?>
><?php /* tag "a" from line 335 */; ?>
<a href="/gioi-thieu">Giới thiệu</a></li>				
				<?php 
/* tag "li" from line 336 */ ;
...
<a class="dropdown-toggle" data-toggle="dropdown">Tổ CHuyên Môn<?php /* tag "b" from line 337 */; ?>
<b class="caret"></b></a>
					<?php /* tag "ul" from line 338 */; ?>
...
>Kỹ Thuật Dựng</a>							
						...
						<?php /* tag "li" from line 342 */; ?>
<li>
							<?php 
/* tag "a" from line 343 */ ;
if (null !== ($_tmp_4 = ('/to-chuyen-mon/kt-am-thanh'))):  ;
...
>Kỹ Thuật Âm Thanh</a>
						...
						<?php /* tag "li" from line 345 */; ?>
<li>
							<?php 
/* tag "a" from line 346 */ ;
if (null !== ($_tmp_3 = ('/to-chuyen-mon/do-hoa'))):  ;
...
<li<?php echo $_tmp_2 ?>
>
					<?php /* tag "a" from line 351 */; ?>
<a class="dropdown-toggle" data-toggle="dropdown">Tin tức<?php /* tag "b" from line 351 */; ?>
<b class="caret"></b></a>
					<?php /* tag "ul" from line 352 */; ?>
<ul class="dropdown-menu">
						<?php /* tag "li" from line 353 */; ?>
<li>
							<?php 
/* tag "a" from line 354 */ ;
if (null !== ($_tmp_4 = ('/tin-tuc/tin-dia-phuong'))):  ;
$_tmp_4 = ' href="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
...
<li>
							<?php 
/* tag "a" from line 357 */ ;
if (null !== ($_tmp_3 = ('/tin-tuc/tin-trong-nuoc'))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
if (null !== ($_tmp_4 = ($ctx->ActiveItem=='Subject'?'active':'?'))):  ;
$_tmp_4 = ' class="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
...
<a href="/tin-tuc/chuyen-de">Chuyên đề</a></li>
				<?php 
/* tag "li" from line 365 */ ;
if (null !== ($_tmp_3 = ($ctx->ActiveItem=='VideoClip'?'active':'?'))):  ;
$_tmp_3 = ' class="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
?>
<li<?php echo $_tmp_3 ?>
><?php /* tag "a" from line 365 */; ?>
<a href="/tin-tuc/video-clip">Video clip</a></li>
				<?php 
...
<a class="dropdown-toggle" data-toggle="dropdown">Ứng Dụng<?php /* tag "b" from line 367 */; ?>
<b class="caret"></b></a>
						<?php /* tag "ul" from line 368 */; ?>
<ul class="dropdown-menu">
						<?php /* tag "li" from line 369 */; ?>
<li>
							<?php 
/* tag "a" from line 370 */ ;
...
>Quản lý Điểm Thù Lao</a>
				...
				<?php 
/* tag "li" from line 374 */ ;
if (null !== ($_tmp_4 = ($ctx->ActiveItem=='LibraryAlbum'?'active':'?'))):  ;
$_tmp_4 = ' class="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<li<?php echo $_tmp_4 ?>
><?php /* tag "a" from line 374 */; ?>
<a href="/thu-vien-anh">Ảnh hoạt động</a></li>							
				<?php 
/* tag "li" from line 375 */ ;
...
<div class="f-left">
					<?php /* tag "p" from line 381 */; ?>
<p><?php /* tag "b" from line 381 */; ?>
<b>© 11/2013 Phòng Kỹ Thuật Thể Hiện</b></p>
					<?php /* tag "p" from line 382 */; ?>
<p>Biên tập - Trưởng Phòng: Nguyễn Quang Phương</p>
					<?php /* tag "p" from line 383 */; ?>
...
<p><?php /* tag "b" from line 388 */; ?>
<b>Địa chỉ:</b> 50 Phạm Thái Bường Phường 4, TP Vĩnh Long</p>
					<?php /* tag "p" from line 389 */; ?>
<p><?php /* tag "b" from line 389 */; ?>
<b>Điện thoại:</b> (073) 822 345</p>
					<?php /* tag "p" from line 390 */; ?>
<p><?php /* tag "b" from line 390 */; ?>
<b>Email:</b> ktthehienthvl@gmail.com</p>					
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_Popup(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
<div>
		<?php /* tag "script" from line 270 */; ?>
<script>
		/*<![CDATA[*/
...
<div id="PopupCarousel" class="carousel slide carousel-fade popup-slide reset-margin">
				<?php /* tag "ol" from line 306 */; ?>
<ol class="carousel-indicators">
					<?php /* tag "li" from line 307 */; ?>
...
<div class="item">
						<?php 
/* tag "a" from line 318 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Sponsor, 'getURLView')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<div id="ads-open" class="ads-open-center"><?php /* tag "i" from line 325 */; ?>
<i class="icon-chevron-up icon-white"></i></div>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_CallendarBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<tr><?php /* tag "td" from line 253 */; ?>
<td colspan="2" id="hoangdao" class="hoangdao"></td></tr>
				</tbody>
			</table>
			<?php /* tag "script" from line 256 */; ?>
<script language="JavaScript">
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_ContactBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<div class="b-content"><?php /* tag "a" from line 226 */; ?>
<a href="/lien-he"><?php /* tag "img" from line 226 */; ?>
<img width="100%" src="/data/images/logo/contact.jpg"/></a></div>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_FixedFunction(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<p class="bubble-item">Trực tuyến</p>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_TopVideoBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
$_tmp_1 = $ctx->repeat ;
...
?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_TopNewsBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="carousel-control right" href="#BoxNewsCarousel" data-slide="next">&rsaquo;</a>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_PictureBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<img width="100%" src="/data/images/logo/top_img.jpg"/>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_BuddhaBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="carousel-control right" href="#BuddhaCarousel" data-slide="next">&rsaquo;</a>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_CallendarBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<marquee behavior="scroll" direction="left" scrollamount="2">
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/lien-he">Liên hệ</a></li>							
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/base.js"></script>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/bootstrap/css/base.css"/>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="icon" href="http://www.ktthehien.com/data/images/icon/favicon.ico" type="image/x-icon"/>
 ...
 ?>
<?php 
function tpl_53b76fc4_base__2figzJzrX7LcIBJZrxyOkQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
