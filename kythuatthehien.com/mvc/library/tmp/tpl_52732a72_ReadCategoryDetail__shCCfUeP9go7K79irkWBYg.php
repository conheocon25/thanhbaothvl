<?php 
function tpl_52732a72_ReadCategoryDetail__shCCfUeP9go7K79irkWBYg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div class="page-header pg-header pg-header-news reset-margin">
							<?php /* tag "h4" from line 17 */; ?>
<h4 class="reset-margin"><?php echo phptal_escape($ctx->Title); ?>
</h4>
							<?php /* tag "i" from line 18 */; ?>
<i class="pull-right">Cập nhật: <?php /* tag "span" from line 18 */; ?>
...
<a class="btn btn-success pull-right" href="https://www.facebook.com/sharer/sharer.php?u=http://www.ktthehien.com/tin-tuc/tin-dai-thvl" target="_blank"><?php /* tag "i" from line 24 */; ?>
<i class="icon-share icon-white"></i> Chia sẻ</a>
									<?php /* tag "a" from line 25 */; ?>
<a class="btn btn-primary pull-right" href="https://www.facebook.com/sharer/sharer.php?u=http://www.ktthehien.com/tin-tuc/tin-dai-thvl" target="_blank"><?php /* tag "i" from line 25 */; ?>
...
<li class="active news-list-title"><?php /* tag "a" from line 31 */; ?>
<a>Các bài khác</a></li>
								<?php 
/* tag "li" from line 32 */ ;
$_tmp_1 = $ctx->repeat ;
