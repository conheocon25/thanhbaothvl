<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_Backontop(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<div class="crunchify-top" data-toggle="tooltip" data-placement="left" data-original-title="Trở về đầu trang"></div><?php 
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<b>Email:</b> ktthehienthvl@gmail.com</p>					
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_Popup(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="icon-chevron-up icon-white"></i></div>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_CallendarBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script language="JavaScript">
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_ContactBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<img width="100%" src="/data/images/logo/contact.jpg"/></a></div>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_FixedFunction(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<p class="bubble-item">Trực tuyến</p>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_AskBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<img width="100%" src="/data/images/logo/question.jpg"/>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_TopMonkBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_TopVideoBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
$_tmp_1 = $ctx->repeat ;
...
?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_TopNewsBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="carousel-control right" href="#BoxNewsCarousel" data-slide="next">&rsaquo;</a>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_PictureBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<img width="100%" src="/data/images/logo/top_img.jpg"/>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_BuddhaBox(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="carousel-control right" href="#BuddhaCarousel" data-slide="next">&rsaquo;</a>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_CallendarBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<marquee behavior="scroll" direction="left" scrollamount="2">
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li>
							<?php 
/* tag "a" from line 73 */ ;
if (null !== ($_tmp_2 = ('/tin-tuc/tin-the-thao'))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
>Tin Thể Thao</a>
				...
				<?php 
/* tag "li" from line 77 */ ;
if (null !== ($_tmp_2 = ($ctx->ActiveItem=='Subject'?'active':'?'))):  ;
$_tmp_2 = ' class="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<a href="/chuyen-de">Chuyên đề</a></li>
				<?php 
/* tag "li" from line 78 */ ;
if (null !== ($_tmp_1 = ($ctx->ActiveItem=='VideoClip'?'active':'?'))):  ;
$_tmp_1 = ' class="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<a class="dropdown-toggle" data-toggle="dropdown">Tổ Chuyên Môn<?php /* tag "b" from line 80 */; ?>
<b class="caret"></b></a>
...
<a href="/lien-he">Liên hệ</a></li>							
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/base.js"></script>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/bootstrap/css/base.css"/>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="icon" href="http://www.ktthehien.com/data/images/icon/favicon.ico" type="image/x-icon"/>
 ...
 ?>
<?php 
function tpl_53b76a87_base__2figzJzrX7LcIBJZrxyOkQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
