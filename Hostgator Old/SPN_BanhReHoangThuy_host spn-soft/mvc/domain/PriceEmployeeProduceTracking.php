...
class PriceEmployeeProduceTracking extends Object{
	...
	/*--------------------------------------------------------------------*/
	function getURLUpdatePEP01( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=1&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP02( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=2&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP03( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=9&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP04( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=10&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP05( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=15&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP06( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=16&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP07( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=20&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP08( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=21&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP09( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=25&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP10( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=26&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP11( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=30&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP12( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=34&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP13( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=35&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP14( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=39&IdEmployee=".$this->Id;
    }
	function getURLUpdatePEP15( ) {
		return "?cmd=UpdatePriceEmployeeProduce&IdFactory=".$this->IdFactory."&IdProduct=40&IdEmployee=".$this->Id;
    }
}
?>