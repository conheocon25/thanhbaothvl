...
class SPNSendMail{
		...
		****************************************************************************/
		...
		function SendMail($frommail,$tomail,$subject,$message,$fromfullname="furniture.skytech.vn")
		{
			  ...
			  $smtp_host ='mail.123app.net';//Dia chi mail server
			  $admin_email = 'contact@123app.net';//User duoc khai bao tren mail server
			  $smtp_username = 'contact@123app.net';//User duoc khai bao tren mail server
			  $smtp_password = 'admin123456';//Pass cua email nay
