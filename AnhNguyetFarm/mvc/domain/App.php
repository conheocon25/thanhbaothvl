...
class App extends Object{
	...
	//URL của AO NUÔI
	//---------------------------------------------------------------------
	function getURLSettingPond(){
		return "/".$this->Alias."/setting#pond";
	}
	function getURLSettingPondInsLoad(){
		return "/".$this->Alias."/setting/pond/ins/load";
	}
	function getURLSettingPondInsExe(){
		return "/".$this->Alias."/setting/pond/ins/exe";
	}
	...
	//---------------------------------------------------------------------
	function getURLReportPond(){
		return "/".$this->Alias."/report#pond";
	}
