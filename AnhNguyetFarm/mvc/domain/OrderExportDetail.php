...
class OrderExportDetail extends Object{
	...
	function getURLUpdLoad(){
		...
		return "/".$App."/export/".$Order->getPond()->getId()."/".$this->getIdOrder()."/".$this->getIdResource()."/upd/load";
	}
	function getURLUpdExe(){
		$App = @\MVC\Base\SessionRegistry::getCurrentUser()->getApp()->getAlias();
		return "/".$App."/export/".$Order->getPond()->getId()."/".$this->getIdOrder()."/".$this->getIdResource()."/upd/exe";
	}
	
	function getURLDelLoad(){
		$Order = $this->getOrder();
		$App = @\MVC\Base\SessionRegistry::getCurrentUser()->getApp()->getAlias();
		return "/".$App."/export/".$Order->getPond()->getId()."/".$this->getIdOrder()."/".$this->getIdResource()."/del/load";
	}
	function getURLDelExe(){
		$Order = $this->getOrder();
		$App = @\MVC\Base\SessionRegistry::getCurrentUser()->getApp()->getAlias();
		return "/".$App."/export/".$Order->getPond()->getId()."/".$this->getIdOrder()."/".$this->getIdResource()."/del/exe";
	}
