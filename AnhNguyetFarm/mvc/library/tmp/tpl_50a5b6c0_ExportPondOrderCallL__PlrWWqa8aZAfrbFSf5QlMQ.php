<?php 
function tpl_50a5b6c0_ExportPondOrderCallL__PlrWWqa8aZAfrbFSf5QlMQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/ExportPondOrderCallLoad.js"></script>
	</head>
...
<li data-role="list-divider"><?php echo phptal_escape('XUẤT HÀNG CHO '.$ctx->Pond->getName()); ?>
</li>
					<?php 
/* tag "li" from line 21 */ ;
$_tmp_4 = $ctx->repeat ;
...
Generated by PHPTAL from /home/a23app/public_html/anhnguyetfarm/mvc/templates/ExportPondOrderCallLoad.html (edit that file instead) */; ?>