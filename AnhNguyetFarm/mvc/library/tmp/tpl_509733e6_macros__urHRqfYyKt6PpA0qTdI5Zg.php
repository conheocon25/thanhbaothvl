<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg_header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<img border="0" width="100%" src="/data/images/app/banner.jpg"/></div>
 ...
 ?>
<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg_MobileMenuMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
>THIẾT LẬP</a></li>
 ...
 ?>
<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg_MobileMenuSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="#Term" data-transition="none" data-inline="true">CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg_IncludeJS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/library/mobiscroll-2.0.2.custom.min.js"></script>
 ...
 ?>
<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg_IncludeCSS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/base/mobiscroll-2.0.2.custom.min.css"/>
 ...
 ?>
<?php 
function tpl_509733e6_macros__urHRqfYyKt6PpA0qTdI5Zg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
