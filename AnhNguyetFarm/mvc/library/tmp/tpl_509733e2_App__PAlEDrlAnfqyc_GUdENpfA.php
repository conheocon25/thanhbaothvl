<?php 
function tpl_509733e2_App__PAlEDrlAnfqyc_GUdENpfA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<li><?php 
/* tag "a" from line 53 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->User, 'getApp/getURLMain')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 60 */; ?>
<p>&copy; 2012 SPN Co, Ltd.</p></div>
	</div>
</body>
</html><?php 
