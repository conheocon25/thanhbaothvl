<?php 
function tpl_512f21f7_ImportSupplierOrderD__tww_BXfaGBfATuMBJOgbxA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<b data-theme="a">
							 <?php 
/* tag "a" from line 50 */ ;
if (null !== ($_tmp_2 = ($ctx->Page->getId()==$ctx->OrderImport->getCurrentImportPage()?'a':'c'))):  ;
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 61 */; ?>
