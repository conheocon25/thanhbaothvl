<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q_MobileMenuReport(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<li id="ReportOther"><?php 
/* tag "a" from line 68 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->User, 'getApp/getURLReportOther')))):  ;
$_tmp_1 = ' href="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
...
>CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q_MobileMenuMain(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
>THIẾT LẬP</a></li>
 ...
 ?>
<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q_MobileMenuSettings(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="#Term" data-transition="none" data-inline="true">CHI KHÁC</a></li>
 ...
 ?>
<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q_IncludeJS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/library/mobiscroll-2.0.2.custom.min.js"></script>
 ...
 ?>
<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q_IncludeCSS_Mobile(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
<?php 
echo 'Hệ Thống Quản Lý Bán Hàng' ;
endif ;
$ctx->noThrow(false) ;
?>
</title>
		<?php /* tag "BASE" from line 6 */; ?>
<BASE href="http://minhtai.spn-soft.com"/>
...
<meta name="description" content="Hệ thống quản lý bán hàng"/>
		<?php /* tag "meta" from line 13 */; ?>
<meta name="page-topic" content="Hệ thống quản lý bán hàng"/>
		<?php /* tag "meta" from line 14 */; ?>
<meta name="Abstract" content="Hệ thống quản lý bán hàng"/>
		<?php /* tag "meta" from line 15 */; ?>
<meta name="classification" content="Hệ thống quản lý bán hàng"/>
...
<link rel="stylesheet" type="text/css" href="/mvc/templates/theme/base/mobiscroll-2.0.2.custom.min.css"/>
 ...
 ?>
<?php 
function tpl_5208984b_macros__0OnVgNaylw2OXGYLw_PN1Q(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from /home/spnsoft/public_html/minhtai/mvc/templates/macros.xhtml (edit that file instead) */; ?>