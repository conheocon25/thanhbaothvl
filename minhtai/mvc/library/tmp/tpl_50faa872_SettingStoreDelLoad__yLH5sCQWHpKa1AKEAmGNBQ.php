<?php 
function tpl_50faa872_SettingStoreDelLoad__yLH5sCQWHpKa1AKEAmGNBQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Store, 'getURLDelExe')))):  ;
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/SettingStoreDelLoad.html (edit that file instead) */; ?>