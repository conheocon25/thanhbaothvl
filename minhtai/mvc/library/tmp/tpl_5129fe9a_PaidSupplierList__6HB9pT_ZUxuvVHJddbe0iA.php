<?php 
function tpl_5129fe9a_PaidSupplierList__6HB9pT_ZUxuvVHJddbe0iA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/PaidSupplierList.js"></script>
	</head>
...
<h1><?php echo phptal_escape('CHI TRẢ '.$ctx->Supplier->getName()); ?>
</h1>
			<?php 
/* tag "a" from line 13 */ ;
...
<div class="content-primary">
				<?php 
/* tag "a" from line 18 */ ;
if (null !== ($_tmp_3 = ($ctx->path($ctx->Supplier, 'getURLPaidInsLoad')))):  ;
$_tmp_3 = ' href="'.phptal_escape($_tmp_3).'"' ;
else:  ;
$_tmp_3 = '' ;
endif ;
...
/* tag "li" from line 20 */ ;
$_tmp_3 = $ctx->repeat ;
$_tmp_3->Paid = new PHPTAL_RepeatController($ctx->path($ctx->Supplier, 'getPaidsTop10'))
 ;
$ctx = $tpl->pushContext() ;
...
?>
				...
				<?php 
/* tag "a" from line 28 */ ;
if (null !== ($_tmp_4 = ($ctx->path($ctx->Supplier, 'getURLPaidInsLoad')))):  ;
$_tmp_4 = ' href="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
...
>
							<?php 
/* tag "a" from line 35 */ ;
if (null !== ($_tmp_5 = ($ctx->path($ctx->Supplier1, 'getURLPaid')))):  ;
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/PaidSupplierList.html (edit that file instead) */; ?>