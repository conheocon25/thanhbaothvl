<?php 
function tpl_5208984d_SellingCustomerOrder__Vi0RIaG8JHAnRGG8TbSp2g(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
$_tmp_1 = $ctx->repeat ;
$_tmp_1->OE = new PHPTAL_RepeatController($ctx->OEs)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_1->OE as $ctx->OE): ;
?>
<div class="order type-interior">
...
<li>
						<?php 
/* tag "a" from line 20 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->OE, 'getURLUpdLoad')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<span><?php echo phptal_escape($ctx->path($ctx->OE, 'getStore/getName')); ?>
</span></h3>
							<?php /* tag "span" from line 22 */; ?>
<span class="ui-li-aside"><?php echo phptal_escape($ctx->path($ctx->OE, 'getDatePrint')); ?>
</span>
							<?php /* tag "p" from line 23 */; ?>
<p><?php /* tag "span" from line 23 */; ?>
<span><?php echo phptal_escape($ctx->path($ctx->OE, 'getNote')); ?>
</span></p>
						</a>
						<?php 
/* tag "a" from line 25 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->OE, 'getURLPrint')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
<span class="ui-li-aside"><?php echo phptal_escape($ctx->path($ctx->OE, 'getValue1Print')); ?>
</span>
					</li>
					<?php 
/* tag "li" from line 30 */ ;
$_tmp_2 = $ctx->repeat ;
$_tmp_2->Detail = new PHPTAL_RepeatController($ctx->path($ctx->OE, 'getDetails'))
 ;
$ctx = $tpl->pushContext() ;
...
<span class="ui-li-aside"><?php echo phptal_escape($ctx->path($ctx->OE, 'getValue2Print')); ?>
</span>
					</li>
					<?php 
/* tag "li" from line 43 */ ;
$_tmp_3 = $ctx->repeat ;
$_tmp_3->Detail = new PHPTAL_RepeatController($ctx->path($ctx->OE, 'getDetailExtras'))
 ;
$ctx = $tpl->pushContext() ;
...
<span class="ui-li-aside"><?php echo phptal_escape($ctx->path($ctx->OE, 'getValuePrint')); ?>
</span>
...
<span><?php echo phptal_escape($ctx->path($ctx->OE, 'getValueStrPrint')); ?>
				...
				<?php 
/* tag "a" from line 60 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->OE, 'getURLCallLoad')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
...
$_tmp_3 = $ctx->repeat ;
$_tmp_3->P = new PHPTAL_RepeatController($ctx->path($ctx->Pages, 'getPages'))
 ;
$ctx = $tpl->pushContext() ;
...
<span>
							<?php 
/* tag "a" from line 68 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->P, 'getURL')))):  ;
$_tmp_2 = ' href="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
if (null !== ($_tmp_4 = ($ctx->Page==$ctx->P->getId()?'curent':'?'))):  ;
$_tmp_4 = ' class="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<a data-theme="b" data-ajax="false"<?php echo $_tmp_2 ?>
<?php echo $_tmp_4 ?>
...
/* tag "li" from line 72 */ ;
$_tmp_2 = $ctx->repeat ;
$_tmp_2->OE1 = new PHPTAL_RepeatController($ctx->OEs)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_2->OE1 as $ctx->OE1): ;
if (null !== ($_tmp_4 = ($ctx->OE->getId()==$ctx->OE1->getId()?'a':'c'))):  ;
...
<div data-role="footer" class="footer-docs" data-theme="c"><?php /* tag "p" from line 79 */; ?>
...
Generated by PHPTAL from /home/spnsoft/public_html/minhtai/mvc/templates/SellingCustomerOrder.html (edit that file instead) */; ?>