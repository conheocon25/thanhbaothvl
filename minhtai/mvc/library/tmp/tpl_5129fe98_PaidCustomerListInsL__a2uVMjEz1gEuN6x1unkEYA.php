<?php 
function tpl_5129fe98_PaidCustomerListInsL__a2uVMjEz1gEuN6x1unkEYA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<div id="PagePaidCustomerListInsLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Customer, 'getURLPaidInsExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormPaidCustomerListInsLoad" data-ajax="false" method="post" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/PaidCustomerListInsLoad.html (edit that file instead) */; ?>