<?php 
function tpl_52089855_SettingUnitInsLoad__RjWts1Udf1DUYxDzdKd3jQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/SettingUnitInsLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PageSettingUnitInsLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->User, 'getApp/getURLSettingUnitInsExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form data-ajax="false" id="FormSettingUnitInsLoad" method="post" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
Generated by PHPTAL from /home/spnsoft/public_html/minhtai/mvc/templates/SettingUnitInsLoad.html (edit that file instead) */; ?>