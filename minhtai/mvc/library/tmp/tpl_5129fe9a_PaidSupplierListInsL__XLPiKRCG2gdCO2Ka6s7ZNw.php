<?php 
function tpl_5129fe9a_PaidSupplierListInsL__XLPiKRCG2gdCO2Ka6s7ZNw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/PaidSupplierListInsLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PagePaidSupplierListInsLoad" data-role="page">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Supplier, 'getURLPaidInsExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormPaidSupplierListInsLoad" data-ajax="false" method="post" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
<input class="required" type="date" name="Date" id="Date"/>
					</div>
...
<input class="required" id="Value" name="Value" type="text"/>
					</div>
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/PaidSupplierListInsLoad.html (edit that file instead) */; ?>