<?php 
function tpl_5122f556_ReportStoreDetail__xZaw4xiRBITnGbdsQyz6tw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
>
							<?php 
/* tag "a" from line 37 */ ;
if (null !== ($_tmp_5 = ('#'.$ctx->Store1->getIdPrint()))):  ;
...
<li>
							<?php 
/* tag "a" from line 72 */ ;
if (null !== ($_tmp_2 = ('#'.$ctx->Store1->getIdPrint()))):  ;
