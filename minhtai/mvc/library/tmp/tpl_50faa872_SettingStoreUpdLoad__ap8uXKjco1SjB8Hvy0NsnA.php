<?php 
function tpl_50faa872_SettingStoreUpdLoad__ap8uXKjco1SjB8Hvy0NsnA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<script type="text/javascript" language="javascript" src="/mvc/templates/script/user/SettingStoreUpdLoad.js"></script>
	</head>
<?php /* tag "body" from line 8 */; ?>
<body>
	<?php /* tag "div" from line 9 */; ?>
<div id="PageSettingStoreUpdLoad" data-role="page" class="type-interior">
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Store, 'getURLUpdExe')))):  ;
$_tmp_1 = ' action="'.phptal_escape($_tmp_1).'"' ;
else:  ;
$_tmp_1 = '' ;
endif ;
?>
<form id="FormSettingStoreUpdLoad" method="post" data-ajax="false" class="ui-body ui-body-a ui-corner-all"<?php echo $_tmp_1 ?>
>
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Store, 'getName')))):  ;
...
if (null !== ($_tmp_2 = ($ctx->path($ctx->Store, 'getAddress')))):  ;
$_tmp_2 = ' value="'.phptal_escape($_tmp_2).'"' ;
else:  ;
$_tmp_2 = '' ;
endif ;
?>
<input id="Address" name="Address" type="text" class="required"<?php echo $_tmp_2 ?>
/>
					</div>
				</fieldset>
...
Generated by PHPTAL from /home/a23app/public_html/minhtai/mvc/templates/SettingStoreUpdLoad.html (edit that file instead) */; ?>