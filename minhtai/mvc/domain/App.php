...
class App extends Object{
	...
	function getURLPaidCustomer(){
		return "/".$this->Alias."/paid#customer";
	}	
	//---------------------------------------------------------------------
	...
	//URL của khách hàng
	//---------------------------------------------------------------------
	function getURLSettingCustomer(){
		return "/".$this->Alias."/setting#customer";
	}
	function getURLSettingCustomerInsLoad(){
		return "/".$this->Alias."/setting/customer/ins/load";
	}
	function getURLSettingCustomerInsExe(){
		return "/".$this->Alias."/setting/customer/ins/exe";
	}
	...
	function getURLSettingStore(){
		return "/".$this->Alias."/setting#store";
	}
	function getURLSettingStoreInsLoad(){
		return "/".$this->Alias."/setting/store/ins/load";
	}
	function getURLSettingStoreInsExe(){
		return "/".$this->Alias."/setting/store/ins/exe";
	}
	...
	function getURLReportStore(){
		return "/".$this->Alias."/report#store";
	}
	function getURLReportStoreDetail(){
		return "/".$this->Alias."/report/store#general";
	}
	//---------------------------------------------------------------------
